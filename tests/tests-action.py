...
class VlanPrioAction(DataLayerSourceAction):
    ...
    """
    def runTest(self):
        #rule =  ["changeFlowSpace", "ADD", "35000", "all", "dl_src=00:01:00:00:00:02,dl_dst=00:00:00:00:00:10,dl_vlan=1080,dl_vlan_pcp=7,dl_type=testutils.ETHERTYPE_ARP,nw_proto=testutils.ARP_REPLY", "Slice:controller0=4"]
        rule =  ["changeFlowSpace", "ADD", "35000", "all", "dl_src=00:01:00:00:00:02,dl_dst=00:00:00:00:00:10,dl_vlan=1080,dl_vpcp=7", "Slice:controller0=4"]
        (success, data) = testutils.setRule(self, self.sv, rule)
        self.assertTrue(success, "%s: Not success" %(self.__class__.__name__))

        #rule =  ["changeFlowSpace", "ADD", "35000", "all", "dl_vpcp=7", "Slice:controller0=4"]
        #(success, data) = testutils.setRule(self, self.sv, rule)
        #self.assertTrue(success, "%s: Not success" %(self.__class__.__name__))
        ...
        #rule =  ["changeFlowSpace", "ADD", "35000", "all", "dl_vpcp=5", "Slice:controller0=4"]
        #(success, data) = testutils.setRule(self, self.sv, rule)
        #self.assertTrue(success, "%s: Not success" %(self.__class__.__name__))

        pkt = testutils.simplePacket(dl_src="00:01:00:00:00:02", dl_dst="00:00:00:00:00:10", dl_vlan=1080, dl_vlan_pcp=7)
        #pkt = testutils.simplePacket(dl_src="00:01:00:00:00:02", dl_dst="00:00:00:00:00:10", dl_vlan=1080, dl_vlan_pcp=7, dl_type=testutils.ETHERTYPE_ARP, nw_proto=testutils.ARP_REPLY)
...
class StripVlanAction(DataLayerSourceAction):
    ...
    def runTest(self):
        ...
        #exp_list = [["controller", 0, message.features_request()]]
        res = testutils.ofmsgSndCmp(self, snd_list, exp_list, xid_ignore=True)
